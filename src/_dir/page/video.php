...
<body>
    ...
    <?php if ($ext == 'flv') { ?><script src="//cdn.bootcdn.net/ajax/libs/flv.js/1.6.2/flv.min.js"></script><?php } ?>
    <script src="//cdn.bootcdn.net/ajax/libs/dplayer/1.27.0/DPlayer.min.js"></script>
